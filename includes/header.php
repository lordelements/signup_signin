<?php 
    $pageTitle = "USER PANEL DASHBOARD";
    session_start();
...
<head>
    ...
    <title><?php  if(isset($pageTitle)) {echo $pageTitle; } else{echo 'USER_PANEL';}?></title>
</head>
        ...
        <header class="bg-nav">
            <div class="flex justify-between">
                ...
                <div class="p-1 flex flex-row items-center">
                    ...
                    <a href="#" onclick="profileToggle()" class="text-white p-2 no-underline hidden md:block lg:block"><?php echo "" . $_SESSION['username'] ." - ". $_SESSION['usertype'] . ""; ?></a>
